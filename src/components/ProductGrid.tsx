  ...
  return (
    <section id="products" className="py-20 px-6">
      <div className="container mx-auto">
        <h2 className="font-display font-black text-3xl md:text-4xl text-foreground mb-12 tracking-tight">
          COLLECTION
        </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-56 shrink-0 space-y-8">
            {/* Category */}
            <div>
              <h4 className="font-display text-xs font-bold tracking-[0.2em] text-muted-foreground mb-4">
                CATEGORY
              </h4>
              <div className="flex flex-wrap lg:flex-col gap-2">
                {allCategories.map((c) => (
                  <button
                    ...
                    className={`text-left font-body text-sm transition-colors duration-200 ${
                      selectedCategory === c
              ...
              <div className="flex flex-wrap gap-2">
                {allSizes.map((s) => (
                  <button
                    key={s}
                    onClick={() =>
                      toggleFilter(s, selectedSizes, setSelectedSizes)
                    }
                    className={`w-10 h-10 text-xs font-display font-bold border transition-colors duration-200 ${
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {filtered.length === 0 && (
              <p className="col-span-full text-center text-muted-foreground font-body py-20">
